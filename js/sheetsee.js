...
module.exports.d3BarChart = function(data, options) {
  ...
  var mouseOver = function() {
      ...
      selectedBar.style("cursor", "pointer")

      var valueSelector = "." + "valueb-" + indexValue
      var selectedValue = d3.selectAll(valueSelector)
      selectedValue.style("visibility", "hidden")
      selectedValue.style("cursor", "none")

      var valueSelector = "." + "value-" + indexValue
      var selectedValue = d3.selectAll(valueSelector)
      selectedValue.style("visibility", "visible")
      selectedValue.style("cursor", "none")
  ...
  bar.append("text")
    .attr("x", -6)
    .attr("y", (y.rangeBand()+3) / 2)
    .attr("dx", 12)
    .attr("dy", ".35em")
    .attr("text-anchor", "start")
    .attr("index_value", function(d, i) { return "index-" + i })
    .attr("visibility", "hidden")
    .text(function(d) { return (format(d.units) + options.yaxis) })
  ...
  bar.append("text")
    ...
    .attr("class", function(d, i) { return "valueb-" + "index-" + i })
    .style("fill", "#555555")
    .on('mouseover', mouseOver)
    .on("mouseout", mouseOut)
...
module.exports.getColumnAverage = function(data, column) {
  var total = Sheetsee.getColumnTotal(data, column)
